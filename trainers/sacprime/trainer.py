...
from mlagents.trainers.sacprime.optimizer_torch import TorchSACPRIMEOptimizer
from mlagents.trainers.trajectory import Trajectory, ObsUtil
from mlagents.trainers.behavior_id_utils import BehaviorIdentifiers
from mlagents.trainers.settings import TrainerSettings, SACPRIMESettings
...
class SACPRIMETrainer(RLTrainer):
    """
    ...
    def __init__(
        ...
        self.optimizer: TorchSACPRIMEOptimizer = None  # type: ignore
        self.hyperparameters: SACPRIMESettings = cast(
            SACPRIMESettings, trainer_settings.hyperparameters
        )
        self._step = 0
    ...
    def _update_policy(self) -> bool:
        ...
        """
        policy_was_updated = self._update_sacprime_policy()
    ...
    def _update_sacprime_policy(self) -> bool:
        """
        ...
        while (
            ...
            logger.debug(f"Updating SACPRIME policy at step {self._step}")
    ...
    def create_sacprime_optimizer(self) -> TorchSACPRIMEOptimizer:
        return TorchSACPRIMEOptimizer(  # type: ignore
    ...
    def add_policy(
        ...
        self.optimizer = self.create_sacprime_optimizer()
