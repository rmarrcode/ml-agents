...
from mlagents.trainers.settings import TrainerSettings, SACSettings, SACPRIMESettings
...
class TorchSACPRIMEOptimizer(TorchOptimizer):
    ...
    def __init__(self, policy: TorchPolicy, trainer_params: TrainerSettings):
        ...
        if policy.shared_critic:
            raise UnityTrainerException("SACPRIME does not support SharedActorCritic")
        ...
        hyperparameters: SACPRIMESettings = cast(SACPRIMESettings, trainer_params.hyperparameters)
        ...
        self.q_network = TorchSACPRIMEOptimizer.PolicyValueNetwork(
            self.stream_names,
        ...
        self._log_ent_coef = TorchSACPRIMEOptimizer.LogEntCoef(
        ...
        self.target_entropy = TorchSACPRIMEOptimizer.TargetEntropy(
    ...
    def update(self, batch: AgentBuffer, num_sequences: int) -> Dict[str, float]:
        ...
        wandb.log({
            ...
            'Losses/Q1 Loss': update_stats['Losses/Q1 Loss'],
            'Losses/Q2 Loss': update_stats['Losses/Q2 Loss'],
            'Policy/Discrete Entropy Coeff': update_stats['Policy/Discrete Entropy Coeff'],
            'Policy/Continuous Entropy Coeff': update_stats['Policy/Continuous Entropy Coeff'],
            'Policy/Learning Rate': update_stats['Policy/Learning Rate'],
            'rewards': torch.sum(rewards['extrinsic'], dim=0)
        })
        return update_stats
